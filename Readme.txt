...
1. Возможности библиотеки:
  ...
  Поддерживаются Delphi версий от седьмой и до XE5 включительно (как 32-бита, так и 64).
  Работа в составе FireMonkey приложения не тестировалась.
...
2. Список изменений:
  ...
  1.0.11 (от ?? ???? ???? года)
	...
	Добавлен класс TFWZipModifier, позволяющий производить любые изменения архива "на лету" не требующий перепаковки данных.
	Из-за добавления нового класса перекидываю проект обратно на альфу (надо было раньше думать)
