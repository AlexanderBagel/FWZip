FWZip версия 2.0.14 (от 22 сентября 2026 года)
...
2. Список изменений:
  ...
  2.0.13 (выпуск не осуществлялся)
    - Исправлено отсутствие коррекции FileCommentLength в модификаторе, которое могло привести к разрушению архива при изменении коментария.
